...
export function ExamenView({ onBack, onComplete }) {
    ...
    if (finished) {
        return (_jsxs("div", { className: "animate-fade-in", style: { display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', color: '#F5F3EE' }, children: [_jsx("span", { style: { fontSize: 72, marginBottom: 16 }, children: "\uD83C\uDFC6" }), _jsx("h1", { style: { fontFamily: "'Fraunces', Georgia, serif", fontSize: 48, margin: '0 0 16px', color: '#E8B94A' }, children: "\u00A1Examen Completado!" }), _jsxs("p", { style: { fontSize: 20, color: '#8FA8AA', marginBottom: 40 }, children: ["Puntuaci\u00F3n: ", _jsxs("strong", { style: { color: '#F5F3EE' }, children: [score, " / ", questions.length] })] }), _jsx("button", { onClick: onComplete, style: {
                    ...
                    }, onMouseEnter: e => e.currentTarget.style.transform = 'scale(1.05)', onMouseLeave: e => e.currentTarget.style.transform = 'scale(1)', children: "Volver a la Ruta" })] }));
    }
    ...
    return (_jsxs("div", { className: "animate-fade-in", style: {
            ...
            display: 'flex', flexDirection: 'column', minHeight: '60vh', padding: '40px 20px'
        }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 16, marginBottom: 40 }, children: [_jsx("button", { onClick: onBack, style: { background: 'none', border: 'none', color: '#8FA8AA', cursor: 'pointer', fontSize: 24 }, children: "\u00D7" }), _jsx("div", { style: { flex: 1, background: 'rgba(245,243,238,0.1)', height: 12, borderRadius: 6, overflow: 'hidden' }, children: _jsx("div", { style: {
                                height: '100%', width: `${progressPercent}%`, background: '#E8B94A',
                                borderRadius: 6, transition: 'width 0.3s ease-out'
                            } }) }), _jsxs("span", { style: { color: '#E8B94A', fontWeight: 700, fontSize: 14 }, children: [currentQuestion + 1, " / ", questions.length] })] }), _jsxs("div", { style: { flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }, children: [_jsx("h2", { style: {
                            fontFamily: "'Fraunces', Georgia, serif", fontSize: 32, fontWeight: 700, color: '#F5F3EE',
                            marginBottom: 40, lineHeight: 1.3, textAlign: 'center'
                        }, children: currentQ.question }), _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: 16 }, children: currentQ.options.map((opt, idx) => {
                            ...
                            return (_jsxs("button", { onClick: () => handleSelect(idx), style: {
                                    background: bg,
                                    border: border,
                                    color: color,
                                    borderRadius: 16,
                                ...
                                }, children: [_jsx("span", { children: opt }), isAnswered && isCorrect && _jsx("span", { style: { fontSize: 24 }, children: "\u2705" }), isAnswered && isSelected && !isCorrect && _jsx("span", { style: { fontSize: 24 }, children: "\u274C" })] }, idx));
                        }) })] })] }));
}
